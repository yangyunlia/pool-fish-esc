...
#define EXTI_INT_PWMA_CapCH1_ON     SFRX_SET(PWMA_IER, 1)
#define EXTI_INT_PWMA_CapCH1_OFF    SFRX_RESET(PWMA_IER, 1)
...
#define EXTI_INT_PWMB_CapCH1_ON     SFRX_SET(PWMB_IER, 1)
#define EXTI_INT_PWMB_CapCH1_OFF    SFRX_RESET(PWMB_IER, 1)
