...
typedef enum
{
    ...
    PWM_EdgeAlignment_CenterUp      = 0x02,
    PWM_EdgeAlignment_CenterBoth    = 0x03,
} PWM_EdgeAlignment_t;
...
typedef enum
{
    ...
    PWMA_PortDirIn_TI2FP1_TI1FP2_TI4FP3_TI3FP4  = 0x02,
    PWMA_PortDirInTRC     = 0x03,
...
typedef enum
{
    ...
    PWMB_PortDirIn_TI6FP5_TI5FP6_TI8FP7_TI7FP8  = 0x02,
    PWMB_PortDirInTRC     = 0x03,
...
typedef enum
{
    ...
    PWMB_PWM5_AlterPort_P00 = 0x02,
    PWMB_PWM5_AlterPort_P74 = 0x03,
...
typedef enum
{
    ...
    PWMB_PWM6_AlterPort_P01 = 0x02,
    PWMB_PWM6_AlterPort_P75 = 0x03,
...
typedef enum
{
    ...
    PWMB_PWM7_AlterPort_P02 = 0x02,
    PWMB_PWM7_AlterPort_P76 = 0x03,
...
typedef enum
{
    ...
    PWMB_PWM8_AlterPort_P03 = 0x02,
    PWMB_PWM8_AlterPort_P77 = 0x03,
